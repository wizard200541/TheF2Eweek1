...
const SunRiseSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    tl.to('.ml3', { top: '100%', duration: 4 })
    tl.to('.ml2', { top: '100%', duration: 4 }, '<0.25')
    tl.to('.ml1', { top: '70%', duration: 4 }, '<0.25')
    tl.to('.title', { top: '50%', color: '#FFF', borderColor: '#FFF', duration: 3, onComplete: () => {
  ...
  return (
    <>
      <div ref={container} className="min-h-[100vh] bg-black relative overflow-hidden">
        ...
        <div className="ml2 absolute bottom-[-230px] w-full "><MountainL2 className="w-full h-auto"/></div>
        <div className="ml3 absolute bottom-[-80px] w-full "><MountainL3 className="w-full h-auto"/></div>
        <div className="ml5 absolute bottom-0 w-full" ><MountainL5 className="w-full h-auto"/></div>
        <div className="ml4 absolute bottom-0 left-[105px] w-full" ><MountainL4 className="w-full h-auto"/></div>
      </div>
