const Button = ({ children, btnClassName, className, active, ...rest}) => {
  return (
    ...
    >
      <div className="flex">
        <div
          className={"relative bg-white text-primary min-w-[307px] h-[65px] flex justify-center items-center text-[36px] left-0 top-0 transition-[left,top,background-color] in-expo " +
